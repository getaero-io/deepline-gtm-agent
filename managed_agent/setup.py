...
**Bad:** "Now I'll read the docs... trying Hunter... Hunter failed..."
...
Always write to `~/deepline/data/<slug>/`.
...
Skill docs are injected at session start. Key docs to read first:
